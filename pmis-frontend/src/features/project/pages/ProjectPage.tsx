...
function ProjectPage() {
  ...
  const [searchParams, setSearchParams] =
    useState<ProjectSearchParams>(INITIAL_SEARCH_PARAMS);
   ...
   */
  useEffect(() => {
    fetchProjects(INITIAL_SEARCH_PARAMS);
  }, [fetchProjects]);
  ...
  const handleSearch = (
    ...
    const newParams: ProjectSearchParams = {
      ...params,
      page: 0,
      size: DEFAULT_PAGE_SIZE,
    };
    ...
    <div className="project-page">
      ...
      <section className="project-page__header">
        ...
        <div className="project-page__summary">
          <span className="project-page__summary-label">
            전체 프로젝트
          </span>

          <strong className="project-page__summary-value">
            {totalElements}
          </strong>

          <span className="project-page__summary-unit">
            건
          </span>
        </div>
      </section>
      ...
      {error && (
        <div
          ...
          role="alert"
        >
          <span className="project-page__error-icon">
            !
          </span>
      ...
      <section className="project-page__content">
        <div className="project-page__content-header">
          <div>
            <h2 className="project-page__content-title">
              프로젝트 목록
            </h2>

            <p className="project-page__content-description">
              등록된 프로젝트를 조회할 수 있습니다.
            </p>
          </div>

          <div className="project-page__content-count">
      ...
      {!loading &&
        ...
        totalPages > 0 && (
          <div className="project-page__pagination">
            ...
            <div className="project-page__pagination-info">
